...
function initMainPage(dataArray) {
    ...
    // TODO - init bars
    myBarVisOne = new BarVis('barDivOne', dataArray[1], dataArray[2], true, "States in descending order");
    myBarVisTwo = new BarVis('barDivTwo', dataArray[1], dataArray[2], false, "States in ascending order");
